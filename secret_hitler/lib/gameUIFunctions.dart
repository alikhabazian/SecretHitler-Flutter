...
List <Widget> uiState(context,width,height,GameState game_state){
    ...
    case 'base':
      temp+=<Widget>[
        ...
        TextButton(
          ...
          onPressed: () {
            showMessageDialog(context,game_state.selectedChancellor,game_state.turn,roles,Game_state game_state);
          },
        )
